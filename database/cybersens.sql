...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 08 jan. 2026 à 15:44
...
(15, 'fsqfsq', 'fqsfqs', '<p>dsqf</p>', 'Difficile', 'wifi', 'cyan', 25, 15, 0, 1, 1, '2026-01-08 14:17:27', '2026-01-08 14:17:27'),
(16, 'hjio', 'bhujkin', '<p>cytvu</p>', 'Intermédiaire', 'bug', 'blue', 25, 5, 0, 1, 1, '2026-01-08 15:37:24', '2026-01-08 15:37:24');
...
(53, 15, 's<fs<', 'ww', 'ww', 'ww', '', 'A', '', 'Intermédiaire', 100, 10, '2026-01-08 14:17:54');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('user','creator','admin','superadmin') COLLATE utf8mb4_unicode_ci DEFAULT 'user',
